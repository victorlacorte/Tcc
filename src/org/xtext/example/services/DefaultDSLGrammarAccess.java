...
@Singleton
public class DefaultDSLGrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public DefaultDSLGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.DefaultDSL".equals(grammar.getName())) {
				return grammar;
			}
